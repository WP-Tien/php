...
{
	//print_r($_POST);
	if($_POST["ten_dang_nhap"] == "tiennguyen")
	{
		if($_POST["mat_khau"] == "123")
		{
			$_SESSION["ten_dang_nhap"] = $_POST["ten_dang_nhap"];
			echo "<script>alert('Đăng nhập thành công')</script>";
			header("location: Dangnhapvadatsanpham.php");
		}
		else
		{
  ...
  if($_SESSION["ten_dang_nhap"])
  {
	  ...
	  ?>
		<div class="thao_tac">
			...
			<div><a href="Cacsanpham_dangnhapvadatsanpham.php">Qua trang đặt hàng</a></div>
			<div><a href="Dangnhapvadatsanpham.php?logout=1">Đăng xuất</a></div>
		  </div>
	  </div>
